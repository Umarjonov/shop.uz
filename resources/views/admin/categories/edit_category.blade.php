                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{ url('/admin/edit-category/'.$categoryDetails->id) }}" name="adit_category"
                                  id="adit_category" novalidate="novalidate">@csrf
                                    ...
                                    <div class="controls">
                                        <select name="parent_id" id="parent_id" style="width: 220px">
                                            ...
                                            @foreach($levels as $lev)
                                                <option value="{{ $lev->id }}" {{ ($lev->id==$categoryDetails->parent_id) ? 'selected' : '' }}>{{ $lev->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <input type="submit" value="Adit Category" class="btn btn-success">
                                </div>
                            </form>
                        </div>
                    </div>
